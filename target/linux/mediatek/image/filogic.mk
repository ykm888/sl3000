# Mediatek Filogic (MT7981/MT7986/MT7988) image definitions
# 平台通用逻辑保留，只定义一个设备：sl3000
...
# Cetron 机型头部处理（保留，后面你要用其它板子也可以用）
...
define Device/sl3000
  ...
  # 这里给 rootfs 分区 256MB，和你 128GB eMMC 完全兼容
